...
CREATE TABLE `api_topic_pub_user` (
...
ALTER TABLE `api_service_user`
  ADD PRIMARY KEY (`id_service_user`),
  ADD KEY `id_service` (`id_service`),
  ADD KEY `id_user` (`id_user`);

ALTER TABLE `api_topic`
  ADD PRIMARY KEY (`id_topic`),
  ADD KEY `groupe` (`groupe`),
  ADD KEY `update_service` (`id_service_update`);

ALTER TABLE `api_topic_pub`
  ADD PRIMARY KEY (`id_topic_pub`),
  ADD KEY `groupe` (`groupe`);

ALTER TABLE `api_topic_pub_user`
  ADD PRIMARY KEY (`id_topic_pub_user`),
  ADD KEY `id_topic_pub` (`id_topic_pub`),
  ADD KEY `id_user` (`id_user`);

ALTER TABLE `api_topic_user`
...
ALTER TABLE `api_action`
  MODIFY `id_action` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
ALTER TABLE `api_action_user`
  MODIFY `id_action_user` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
ALTER TABLE `api_service`
  MODIFY `id_service` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
ALTER TABLE `api_service_user`
  MODIFY `id_service_user` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1430;
ALTER TABLE `api_topic`
  MODIFY `id_topic` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
ALTER TABLE `api_topic_pub`
  MODIFY `id_topic_pub` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE `api_topic_pub_user`
  MODIFY `id_topic_pub_user` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
ALTER TABLE `api_topic_user`
  MODIFY `id_topic_user` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1770;
