...
if (isset($_POST['lang']))
{
	$traductionLang = Translate::GetTraductions($_POST['lang']);
	...
	Translate::CreateFileLang($traductionLang, $_POST['lang']);
	
	header('location:traduire.php?ok=1&tlang='.$_POST['lang'].(isset($_POST['all'])?'&all=1':''));
}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="panel-body">
                	...
                	<?php
					$traductionFr = Translate::GetTraductions('fr');
					$traductionLang = Translate::GetTraductions($_GET['tlang']);
					?>
					
                    <div class="row">

        <form method="post" action="traduire.php" class="col-md-12">
        ...
        <thead>
        	<tr>
                ...
                <th style="width:60%;"><?php echo $_GET['tlang'];?></th>
            </tr>
        </thead>
        <tbody>
        <?php
		foreach ($traductionFr as $key => $source)
		{
			if (isset($_GET['all']) || $traductionLang[$key]=='')
			{
				...
				<tr>
					...
					<td><input type="text" style="width:95%;" name="<?php echo $key;?>" class="form-control" value="<?php echo (isset($traductionLang[$key])?$traductionLang[$key]:'');?>" /></td>
				</tr>
				<?php	
			}
		}
