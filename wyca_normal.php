	<div id="pages_wyca_normal" class="global_sub_page <?php echo $INSTALL_STEP >= 100?'active':'';?>">
        <section id="wyca_dashboard" class="page hmi_tuile active">
            ...
            <div class="content">
                <ul class="tuiles row">
                    ...
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile12 todo" data-goto="wyca_help" href="#"><i class="fa fa-question"></i><?php echo __('Help');?></a></li>
                </ul>
				<div class="modal fade modalCurrentSite" id="wyca_dashboard_modalCurrentSite" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
        ...
        <section id="wyca_setup" class="page hmi_tuile with_footer">
            ...
            <div class="content">
                <ul class="tuiles row">
                    ...
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile2" data-goto="wyca_setup_maps" href="#"><i class="fas fa-layer-group"></i><?php echo __('Maps');?></a></li>
					...
					<li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile6" data-goto="wyca_setup_check" href="#"><i class="fas fa-tools"></i><?php echo __('Auto Diag');?></a></li>
					<li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile7" data-goto="wyca_setup_wifi" href="#"><i class="fas fa-wifi"></i><?php echo __('Wifi');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile8" data-goto="wyca_setup_language" href="#"><i class="fa fa-language"></i><?php echo __('Language');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile9" data-goto="wyca_setup_export" href="#"><i class="fa fa-upload"></i><?php echo __('Export site');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile10" data-goto="wyca_setup_import" href="#"><i class="fa fa-download"></i><?php echo __('Import site');?></a></li>
					<li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile11" data-goto="wyca_setup_trinary" href="#"><i class="far fa-map"></i><?php echo __('Map trinary');?></a></li>
					<li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile12" data-goto="wyca_setup_download_map" href="#"><i class="fas fa-file-download"></i><?php echo __('Download map');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile13" data-goto="wyca_setup_reset" href="#"><i class="fa fa-eraser"></i><?php echo __('Factory data reset');?></a></li>
				</ul>
				<div class="popupHelp">
					<h2><?=__('Help')?></h2>
					<div class="content sm-content text-left">
        ...
        <section id="wyca_setup_sites" class="page with_footer">
            ...
            <div class="content">
                <a href="#" class="bBackToDashboard button_goto" data-goto="wyca_dashboard" style="display:none"></a>
        ...
        <section id="wyca_setup_check" class="page hmi_tuile with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_setup"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            	...
            	<div class="max_375" style="position:relative;margin:auto;">
                    ...
                    <ul class="tuiles row max_375" style="position:relative;margin:0;">
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="wyca_setup_check_lidar" data-line="line_lidar" data-line-placement="bottom" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="wyca_setup_check_us" data-line="line_us" data-line-placement="bottom" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="wyca_setup_check_motor" data-line="line_motor" data-line-placement="bottom" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="wyca_setup_check_battery" data-line="line_battery" data-line-placement="top" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="wyca_setup_check_cam3d" data-line="line_sensor" data-line-placement="top" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="wyca_setup_check_leds" data-line="line_leds" data-line-placement="top" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_100 bBackSetupCheck" data-goto="wyca_setup"><?= __('Back')?></a>
            </footer>
        </section>
        ...
        <section id="wyca_setup_import" class="page with_footer">
            ...
            <footer>
                <a href="#" class="btn btn-default button_goto bImportSiteBack btn_footer_left btn_50" data-goto="wyca_setup"><?php echo __('Back');?></a>
