...
<div id="pages_user" class="global_page <?php echo $_SESSION['id_groupe_user'] == 4?'active':'';?>">
    <section id="user_dashboard" class="page hmi_tuile active">
        ...
        <div class="content">
            <ul class="tuiles row">
                <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile1" data-goto="user_edit_map" href="#"><i class="fas fa-map-marked-alt"></i><?php echo __('Map');?></a></li>
							...
							<div class="modal-header">
								<div class="actions mh100vh_55">
									<div class="h100vh_160" style="overflow:auto; text-align:center;">
										...
										<h4 class="h4ModalGoTo"><?=__('Do you want to send the vehicle to this POI ?') ?></h4>
							...
							<div class="modal-header">
								<div class="actions mh100vh_55">
									<div class="h100vh_160" style="overflow:auto; text-align:center">
										...
										<div class="user_edit_map_modalReloadMap_loading loading_big" style="margin-top: 50px;"><i class="fa fa fa-spinner fa-pulse fa-2x"></i></div>
									</div>
									
									<div style="clear:both;"></div>
									
									<a href="#" id="user_edit_map_bAbortReloadMap" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal" ><?php echo __('No');?></a> 
									<a href="#" id="" class="btn btn-primary btn_footer_right btn_50 user_edit_map_bReloadMap"><?php echo __('Reload Map');?></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="modal-content">
							<div class="modal-header">
								<div class="actions mh100vh_55">
									...
									<a href="#" class="btn btn-primary btn_footer_right btn_50 user_edit_map_bReloadMap"><?php echo __('Reload Map');?></a>
								</div>
							</div>
						</div>
					</div>
    ...
    <section id="user_recovery" class="page with_footer">
        ...
        <div class="content">
			...
			<div class="ifRecovery user_recovery_feedback recovery_feedback" style="display:none;">
