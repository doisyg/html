...
<div id="pages_user" class="global_page <?php echo $_SESSION['id_groupe_user'] == 4?'active':'';?>">
    <section id="user_dashbord" class="page hmi_tuile active">
        ...
        <div class="content">
            <ul class="tuiles row">
                <li class="col-xs-4"><a class="button_goto anim_tuiles tuile1" data-goto="user_edit_map" href="#"><i class="fa fa-map-o"></i><?php echo __('Map');?></a></li>
                <li class="col-xs-4"><a class="button_goto anim_tuiles tuile2" data-goto="user_move" href="#"><i class="fa fa-gamepad"></i><?php echo __('Control robot');?></a></li>
                <li class="col-xs-4"><a class="button_goto anim_tuiles tuile3" data-goto="user_recovery" href="#"><i class="fa fa-search"></i><?php echo __('Recovery');?></a></li>
