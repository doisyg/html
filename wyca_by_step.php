	<div id="pages_wyca_by_step" class="global_sub_page <?php echo $INSTALL_STEP < 100?'active':'';?>">
    	<section id="wyca_by_step_lang" class="page hmi_tuile <?php echo $INSTALL_STEP <= 1?'active':'';?>">
            <header>
            ...
            <div class="content">
            	<ul class="tuiles heightauto row">
                	<li class="col-xs-6 col-md-6 col-lg-6">
                        <a href="#" class="select_langue button_goto anim_tuiles tuile_img tuile1" data-goto="wyca_by_step_tops" data-id_lang="1">
                	...
                	<li class="col-xs-6 col-md-6 col-lg-6" style="clear:both; margin-top:20px">
                        <a href="#" class="select_langue button_goto anim_tuiles tuile_img tuile2" data-goto="wyca_by_step_tops" data-id_lang="2">
    	...
    	<!--
    	<section id="wyca_by_step_date" class="page <?php echo $INSTALL_STEP == 2?'active':'';?>">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_wifi"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                ...
                <a href="#" class="save_date button_goto btn btn-default pull-right" data-goto="wyca_by_step_tops">OK <i class="fa fa-chevron-right"></i></a>
                
            </div>
        </section>-->
        
        <section id="wyca_by_step_tops" class="page with_footer hmi_tuile <?php echo $INSTALL_STEP == 2?'active':'';?>">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_lang"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
                <h2><?php echo __('Select available Tops');?></h2>
            </header>
            <div class="content text-center">
            	<div class="wyca_by_step_tops_loading loading_big"><i class="fa fa fa-spinner fa-pulse"></i></div>
                ...
                <a href="#" class="save_tops_next_select button_goto" data-goto="wyca_by_step_top" style="display:none;" data-goto="wyca_by_step_top"></a>
                <a href="#" class="save_tops_next_check button_goto" data-goto="wyca_by_step_check" style="display:none;" data-goto="wyca_by_step_top"></a>   
            ...
            <footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_lang"><?= __('Back')?></a>
				<a href="#" class="save_tops btn btn-primary btn_footer_right btn_50"><?= __('Next')?></a>
            </footer>
        </section>
        
        <section id="wyca_by_step_top" class="page hmi_tuile <?php echo $INSTALL_STEP == 3?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_tops"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
                <h2><?php echo __('Select active Top');?></h2>
            </header>
            <div class="content">
            	<div class="wyca_by_step_top_loading loading_big"><i class="fa fa fa-spinner fa-pulse"></i></div>
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_100 btn_back" data-goto="wyca_by_step_tops"><?= __('Back')?></a>
            </footer>
        </section>
        
        <section id="wyca_by_step_check" class="page hmi_tuile <?php echo $INSTALL_STEP == 4?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_top"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_top"><?= __('Back')?></a>
				<a href="#" class="button_goto wyca_by_step_check_next btn btn-primary btn_footer_right btn_50" data-goto="wyca_by_step_wifi"><i class="fa fa fa-spinner fa-pulse"></i> <?= __('Testing')?></a>
            </footer>
        </section>
		
		<section id="wyca_by_step_wifi" class="page <?php echo $INSTALL_STEP == 5?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_check"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_check" ><?= __('Back')?></a>
				<a href="#" class="skip_wifi button_goto btn btn-primary btn_footer_right btn_50" data-goto="wyca_by_step_sound"><?= __('Skip')?></a>
                <a href="#" class="set_passwd_wifi button_goto" data-goto="wyca_by_step_wifi_password" style="display:none;"></a>
            </footer>
        </section>
        
		<section id="wyca_by_step_wifi_password" class="page with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_wifi"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
                <h2><?php echo __('Wifi');?></h2>
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_wifi"><?= __('Back')?></a>
				<a href="#" class="wyca_by_step_wifi_password_save btn btn-primary btn_footer_right btn_50"><?= __('Connect')?></a>
			</footer>
        </section>
		
		<section id="wyca_by_step_sound" class="page <?php echo $INSTALL_STEP == 6?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_wifi"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_wifi" ><?= __('Back')?></a>
				<a href="#" class="bNextSound button_goto btn btn-primary btn_footer_right btn_50" data-goto="wyca_by_step_site"><?= __('Next')?></a>
            </footer>
        </section>
        
		<section id="wyca_by_step_site" class="page <?php echo $INSTALL_STEP == 10?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_sound"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
				...
				<div class="row">
                    <div class="col-xs-6 text-center">
                    	<a class="button_goto bTuile btn" id="bImportSite" data-goto="wyca_by_step_import_site">
                    		<i class="fas fa-file-import iconMenuBlue"></i>
							<h5 class="iconMenuBlue"><?php echo __('Import existing site with map');?></h5>
                        </a>
                    </div>
                    <div class="col-xs-6 text-center">
                    	<a class="button_goto bTuile btn" id="bCreateSite" data-goto="wyca_by_step_new_site" >
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_100 btn_back" data-goto="wyca_by_step_sound"><?= __('Back')?></a>
            </footer>
        </section>
		
		<section id="wyca_by_step_import_site" class="page <?php echo $INSTALL_STEP == 60?'active':'';?> with_footer">
	        <a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_site"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
                <h2><?php echo __('Site import');?></h2>
            </header>
            <div class="content">
                <div class="wyca_by_step_setup_import_loading loading_big"><i class="fa fa fa-spinner fa-pulse"></i></div>
                <div class="wyca_by_step_setup_import_content">
				...
				<a href="#" class="wyca_by_step_import_site_next button_goto" data-goto="wyca_by_step_site_map" style="display:none;"></a>
            </div>
            <footer>
                <a href="#" class="button_goto btn btn-default btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_site"><?= __('Back')?></a>
                <a href="#" class="btn btn-primary bImportSiteDo btn_footer_right btn_50"><?php echo __('Import');?></a>
            </footer>
        </section>
		
		<section id="wyca_by_step_site_map" class="page <?php echo $INSTALL_STEP == 61?'active':'';?> with_footer">
	        <a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_import_site"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
				...
				<a href="#" class="wyca_by_step_site_map_next button_goto" data-goto="wyca_by_step_site_master_dock" style="display:none;"></a>
            </div>
            <footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_100 btn_back" data-goto=	"wyca_by_step_import_site"><?= __('Back')?></a>
            </footer>
        </section>
		
		<section id="wyca_by_step_site_master_dock" class="page <?php echo $INSTALL_STEP == 62?'active':'';?> with_footer">
	        <a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_site_map"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
				...
				<a href="#" class="wyca_by_step_site_master_dock_next button_goto" data-goto="wyca_by_step_site_recovery" style="display:none;"></a>
            </div>
            <footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_100 btn_back" data-goto="wyca_by_step_site_map"><?= __('Back')?></a>
            </footer>
        </section>
		
		<section id="wyca_by_step_site_recovery" class="page <?php echo $INSTALL_STEP == 63?'active':'';?> with_footer">
	        <a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_site_master_dock"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
			...
			<div class="content">
				...
				<div class="ifRecovery wyca_by_step_site_recovery_feedback recovery_feedback" style="display:none;">
				...
				<a href="#" class="wyca_by_step_site_recovery_next button_goto" data-goto="wyca_by_step_edit_map" style="display:none;"></a>
            </div>
            <footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_50 btn_back" data-goto=	"wyca_by_step_site_master_dock"><?= __('Back')?></a>
				<a href="#" class="button_goto btn btn-warning btn_footer_right btn_50 skip_recovery" data-goto=	"wyca_by_step_edit_map"><?= __('Skip')?></a>
            </footer>
        </section>
		
		<section id="wyca_by_step_new_site" class="page <?php echo $INSTALL_STEP == 11?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_site"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                ...
                <a href="#" class="wyca_by_step_site_next button_goto" data-goto="wyca_by_step_mapping" style="display:none;"></a>
				<div class="popupHelp">
					<h2><?=__('Help')?></h2>
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_site"><?= __('Back')?></a>
				<a href="#" onClick="$('#form_site').submit();" class="wyca_by_step_site_save btn btn-primary btn_footer_right btn_50"><?= __('Next')?></a>
            </footer>
        </section>
		
        <section id="wyca_by_step_mapping" class="page <?php echo $INSTALL_STEP == 12?'active':'';?> hide_photo_back with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_new_site"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                ...
                <div style="text-align:center; font-size:26px;">
                    ...
                    <div class="mapping_view" style="position:absolute; top:0; left:0; right:0; bottom:0; overflow:hidden; display:none; z-index:1000;">
                        <img id="wyca_by_step_mapping_mapping_robot" src="assets/images/robot-dessus.png" width="6" style="position:absolute; bottom:400px; margin-left:-3px; z-index:300;" />
                        <img class="map_dyn" id="wyca_by_step_mapping_img_map_saved" src="" style="position:absolute; z-index:200" />
                    </div>
					...
					<div class="modal fade" id="wyca_by_step_mapping_modalConfirm" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
						<div class="modal-dialog" role="dialog">
							<div class="modal-content">
								<div class="modal-header">
									<div class="actions mh100vh_55">
										...
										<a href="#" class="btn btn-primary bMappingStop button_goto btn_footer_right btn_50" data-dismiss="modal" data-goto="wyca_by_step_mapping_fin"><?php echo __('Save');?></a>
									</div>
								</div>
							</div>
						</div>
            ...
            <footer>
            	<a href="#" class="ifNMapping bMappingBack btn btn-default button_goto btn_footer_left btn_33 btn_back" data-goto="wyca_by_step_new_site" ><?php echo __('Back');?></a>
		...
		<section id="wyca_by_step_mapping_fin" class="page <?php echo $INSTALL_STEP == 13?'active':'';?> hide_photo_back with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_mapping"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
                <h2><?php echo __('Mapping config');?></h2>
            </header>
            <div class="content mh100vh_110">
				<form id="wyca_by_step_mapping_form" method="post" style="margin-bottom:10px"> 
					<input type="hidden" name="todo" value="saveMapping" />
					<input type="hidden" id="wyca_by_step_mapping_from_image" name="image" value="" />
					<input type="hidden" id="wyca_by_step_mapping_from_image_tri" name="image_tri" value="" />
					<input type="hidden" id="wyca_by_step_mapping_from_ros_hauteur" name="ros_hauteur" value="" />
					<input type="hidden" id="wyca_by_step_mapping_from_ros_largeur" name="ros_largeur" value="" />
					<input type="hidden" id="wyca_by_step_mapping_from_threshold_free" name="threshold_free" value="" />
					<input type="hidden" id="wyca_by_step_mapping_from_threshold_occupied" name="threshold_occupied" value="" />
					<input type="text" id="wyca_by_step_mapping_from_name" name="nom" placeholder="<?php echo __('Map name')?>" class="form-control"/>
				</form>

				<div id="wyca_by_step_mapping_divResultTrinary" style="flex:1 1 100%;background-color:#f0f0f0;display:flex;justify-content:center;align-items:center;position:relative">
					<i style="font-size:60px;" class="fa fa-spinner fa-pulse loading_fin_create_map"></i>
					
					<svg id="wyca_by_step_mapping_svg" width="0" height="0" style="position:absolute; top:0; left:0; width:100%; height:100%;">
						<image id="wyca_by_step_mapping_image" xlink:href="" x="0" y="0" height="0" width="0" />
					</svg>
					
                    <div id="wyca_by_step_mapping_zoom_carte_container" >
                        <div id="wyca_by_step_mapping_zoom_carte">
                            <img src=""  class="img-responsive" style="max-width:100%; max-height:100%;" />
                            <div id="wyca_by_step_mapping_zone_zoom" style="position:absolute; border:1px solid #00F;"></div>
                            <div id="wyca_by_step_mapping_zone_zoom_click" style="position:absolute; width:100%; height:100%; top:0; left:0; cursor:pointer;"></div>
                        </div>
                    </div>
					
					<canvas id="wyca_by_step_mapping_canvas_result_trinary" width="" height="" style="max-width:100%; max-height:65vh;display:none;"></canvas>
					
				</div>
				<div class="fin_mapping_view" >
					<img id="wyca_by_step_mapping_img_map_saved_fin" src="" style="z-index:200; display:none; max-width:100%;" />
					<div id="">
						<div class="threshold_wrapper">
							<div class="slider_wrapper">
								<span class="btn btn_slider_minus"><i class="fas fa-minus-square"></i></span>
								<div id="wyca_by_step_mapping_threshold_free_slider_elem" class="mt-lg mb-lg slider-primary" data-plugin-slider data-plugin-options='{ "value": 25, "range": "min", "max": 100 }' data-plugin-slider-output="#wyca_by_step_mapping_threshold_free_slider">
									<input id="wyca_by_step_mapping_threshold_free_slider" type="hidden" value="25" />
								</div>
								<span class="btn btn_slider_plus"><i class="fas fa-plus-square"></i></span>
							</div>
							<p id="wyca_by_step_mapping_threshold_free_output"><?php echo __('Empty area threshold');?> : <b>25</b></p>
						</div>
						
						<div class="threshold_wrapper">
							<div class="slider_wrapper">
								<span class="btn btn_slider_minus"><i class="fas fa-minus-square"></i></span>
								 <div id="wyca_by_step_mapping_threshold_occupied_slider_elem" class="mt-lg mb-lg slider-primary" data-plugin-slider data-plugin-options='{ "value": 65, "range": "min", "max": 100 }' data-plugin-slider-output="#wyca_by_step_mapping_threshold_occupied_slider">
									<input id="wyca_by_step_mapping_threshold_occupied_slider" type="hidden" value="65" />
								</div>
								<span class="btn btn_slider_plus"><i class="fas fa-plus-square"></i></span>
							</div>
							<p id="wyca_by_step_mapping_threshold_occupied_output"><?php echo __('Object detection threshold');?> : <b>65</b></p>
						</div>
            ...
            <footer>
            	<a href="#" class="btn btn-default button_goto bMappingCancelMap2 btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_mapping"><?php echo __('Back');?></a>           
                <a href="#" class="btn btn-primary bMappingSaveMap btn_footer_right btn_50"><?php echo __('Save');?></a>
                <a href="#" class="wyca_by_step_mapping_fin_next button_goto" data-goto="wyca_by_step_edit_map" style="display:none;"></a>   
            </footer>
        </section>
       
		<section id="wyca_by_step_mapping_use" class="page hide_photo_back with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_mapping"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
                <h2><?php echo __('Mapping config');?></h2>
            ...
            <footer>
            	<a href="#" class="btn btn-warning button_goto bUseThisMapNowNo btn_footer_left btn_50" data-goto="wyca_by_step_edit_map"><?php echo __('No');?></a>           
                <a href="#" class="btn btn-primary bUseThisMapNowYes btn_footer_right btn_50"><?php echo __('Yes');?></a>
                <a href="#" class="wyca_by_step_mapping_use_next button_goto" data-goto="wyca_by_step_edit_map" style="display:none;"></a>                   
            </footer>
        </section>
         
		<section id="wyca_by_step_edit_map" class="page <?php echo $INSTALL_STEP == 20?'active':'';?> hide_photo_back with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_mapping"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                <div id="wyca_by_step_edit_map_container_all">
					<div class="btn-circle btn-lg burger_menu" data-open="wyca_by_step_edit_map_menu">
					...
					<div class="btn-circle btn-lg icon_menu" data-menu="wyca_by_step_edit_map_menu_point">
						<i class="fas fa-draw-polygon icon_menu_point iconMenuGreen" style="transform: scale(2.5);left: 17px;top: -23px;"></i>
					</div>
					<div class="btn-circle btn-lg icon_menu" data-menu="wyca_by_step_edit_map_menu_forbidden">
						<div class="iconForbiddenArea"><i class="fas fa-vector-square"></i><i class="fa fa-minus-circle iconMenuRed"></i></div>
					</div>
					<div class="btn-circle btn-lg icon_menu" data-menu="wyca_by_step_edit_map_menu_area">
						<i class="fas fa-draw-polygon iconMenuGreen"></i>
					</div>
					<div class="btn-circle btn-lg icon_menu" data-menu="wyca_by_step_edit_map_menu_gotopose">
						<i class="fa fa-crosshairs iconMenuBlue" style="left: -7px;"></i>
					</div>
					<div class="btn-circle btn-lg icon_menu" data-menu="wyca_by_step_edit_map_menu_dock">
						<i class="fas fa-charging-station iconMenuGreen" style="position: relative;top: -1px;left:-5px;"></i>
					</div>
					<div class="btn-circle btn-lg icon_menu" data-menu="wyca_by_step_edit_map_menu_poi">
                    ...
                    <div id="wyca_by_step_edit_map_zoom_carte_container">
                        <div id="wyca_by_step_edit_map_zoom_carte">
                            <img src=""  class="img-responsive" style="max-width:100%; max-height:100%;" />
                            <div id="wyca_by_step_edit_map_zone_zoom" style="position:absolute; border:1px solid #00F;"></div>
                            <div id="wyca_by_step_edit_map_zone_zoom_click" style="position:absolute; width:100%; height:100%; top:0; left:0; cursor:pointer;"></div>
                        </div>
                    </div>
                
                    <div id="wyca_by_step_edit_map_all" style="position:relative; margin:auto; width:100%;">
                        <div id="wyca_by_step_edit_map_map_navigation" class="zoom" style="position:relative; width:100%; margin:auto; border:1px solid #000;">
                            <svg id="wyca_by_step_edit_map_svg" width="0" height="0" style="position:absolute; top:0; left:0; width:100%; height:100%;">
                                <image id="wyca_by_step_edit_map_image" xlink:href="" x="0" y="0" height="0" width="0" />
                            </svg>
                        </div>
                        <div style="clear:both;"></div>
                    </div>
                    
                    <a href="#" id="wyca_by_step_edit_map_bStop" class="btn btn-circle btn-danger btn-menu"><i class="fa fa-stop"></i></a>
                    <a href="#" id="wyca_by_step_edit_map_bEndGomme" class="btn btn-circle btn-primary btn-menu"><i class="fa fa-check"></i></a>
					...
					<div id="wyca_by_step_edit_map_menu" class="menu_icon_touch" style="position:absolute; left:50%; top:50%;">
                    	<ul>
                    ...
                    <div id="wyca_by_step_edit_map_menu_point" class="menu_icon_touch" style="position:absolute; left:50%; top:50%;">
                    	<ul>
                        	<li><a href="#" class="btn btn-circle btn-default btn-menu bDeletePoint"><i class="fa fa-trash iconMenuRed"></i></a></li>
                        </ul>
                    </div>
                    <div id="wyca_by_step_edit_map_menu_forbidden" class="menu_icon_touch" style="position:absolute; left:50%; top:50%;">
                    	<ul>
                    ...
                    <div id="wyca_by_step_edit_map_menu_dock" class="menu_icon_touch" style="position:absolute; left:50%; top:50%;">
                    	<ul>
                    ...
                    <div id="wyca_by_step_edit_map_menu_poi" class="menu_icon_touch" style="position:absolute; left:50%; top:50%;">
                    	<ul>
                    ...
                    <div id="wyca_by_step_edit_map_menu_augmented_pose" class="menu_icon_touch" style="position:absolute; left:50%; top:50%;">
                    	<ul>
                    ...
                    <div id="wyca_by_step_edit_map_modalTeleop" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog" role="dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                    ...
                    <div id="wyca_by_step_edit_map_modalRecovery" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog" role="dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        <div class="h100vh_160" style="overflow:auto; text-align:center;">
											...
											<div class="ifRecovery" style="text-align:center; margin-top:20px;display:none;"><a href="#" class="btn btn-danger btn-lg bCancelRecovery"><?=__('Cancel Recovery') ?></a></div>
											<div class="ifRecovery wyca_by_step_recovery_feedback recovery_feedback" style="display:none;">
												<hr style="border-top: 1px solid #909090;">
												<div class="row recovery_step RecoveryScan" id="">
													<div class="col-xs-10"><h5><?= __('Scan reflectors')?></h5></div>
													<div class="col-xs-2"><i class="fas fa-check iconMenuGreen" style="display:none;"></i><i class="fa fa fa-spinner fa-pulse"></i></div>
                    ...
                    <div id="wyca_by_step_edit_map_modalDoSaveBeforeTestDock" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog" role="dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                    ...
                    <div id="wyca_by_step_edit_map_modalDoSaveBeforeTestPoi" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog" role="dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                    ...
                    <div id="wyca_by_step_edit_map_modalDoSaveBeforeTestAugmentedPose" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog" role="dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        <div class="h100vh_160" style="overflow:auto">
                                            <form>
                                                ...
                                                <div class="form-group sep">
                                                    ...
                                                    <div class="col-xs-8">
                                                        <div id="wyca_by_step_edit_map_area_color_elem" class="input-group color input-group-sm">
                                                            ...
                                                            <input id="wyca_by_step_edit_map_area_color" name="area_color" type="text" class="form-control" value="#579fb1">
                                                        </div>
												...
												<div class="form-group sep">
                                                    ...
                                                    <div class="col-xs-8">
														<div class="col-xs-12" style="padding:0; margin-bottom:5px;">
															<select id="wyca_by_step_edit_map_led_color_mode" name="led_color_mode" class="form-control input-sm mb-md selectChangeAffGroup">
																<option value="Automatic"><?php echo __('Automatic');?></option>
																<option value="Manual"><?php echo __('Manual');?></option>
															</select>
														</div>
														<div id="wyca_by_step_edit_map_led_color_group" class="col-xs-12" style="padding:0">
																<div id="wyca_by_step_edit_map_led_color_elem" class="input-group color input-group-sm">
																	<span class="input-group-addon"><i class="fas fa-stop preview_color"></i></span>
																	<input id="wyca_by_step_edit_map_led_color" name="led_color" type="text" class="form-control" value="#ff92b4">
																</div>
                                                ...
                                                <div class="form-group sep">
                                                    ...
                                                    <div class="col-xs-8">
                                                    	<div class="col-xs-12" style="padding:0;margin-bottom:5px;">
                                                            <select id="wyca_by_step_edit_map_led_animation_mode" name="led_animation_mode" class="form-control input-sm mb-md selectChangeAffGroup">
                                                                <option value="Automatic"><?php echo __('Automatic');?></option>
                                                                <option value="Manual"><?php echo __('Manual');?></option>
                                                            </select>
                                                    	</div>
                                                        <div id="wyca_by_step_edit_map_led_animation_group" class="col-xs-12" style="padding:0">
                                                            <select id="wyca_by_step_edit_map_led_animation" name="led_animation" class="form-control input-sm mb-md">
                                                ...
                                                <div class="form-group sep">
                                                    ...
                                                    <div class="col-xs-8">
                                                    	<div class="col-xs-12" style="padding:0;margin-bottom:5px;">
                                                            <select id="wyca_by_step_edit_map_max_speed_mode" name="max_speed_mode" class="form-control input-sm mb-md selectChangeAffGroup">
                                                                <option value="Automatic"><?php echo __('Automatic');?></option>
                                                                <option value="Manual"><?php echo __('Manual');?></option>
                                                            </select>
                                                        </div>
                                                        <div id="wyca_by_step_edit_map_max_speed_group" class="col-xs-12 input-group input-group-sm mb-md" style="padding:0">
                                                            <input type="number" id="wyca_by_step_edit_map_max_speed" name="max_speed" class="form-control input-sm mb-md" />
                                                ...
                                                <div class="form-group sep">
                                                    ...
                                                    <div class="col-xs-8">
                                                    	<div class="col-xs-12" style="padding:0;margin-bottom:5px;">
															<select id="wyca_by_step_edit_map_min_distance_obstacle_mode" name="min_distance_obstacle_mode" class="form-control input-sm mb-md selectChangeAffGroup">
																<option value="Automatic"><?php echo __('Automatic');?></option>
																<option value="Manual"><?php echo __('Manual');?></option>
															</select>
                                                        </div>
                                                        <div id="wyca_by_step_edit_map_min_distance_obstacle_group" class="col-xs-12 input-group input-group-sm mb-md" style="padding:0">
                                                            <input type="number" id="wyca_by_step_edit_map_min_distance_obstacle" name="min_distance_obstacle" class="form-control input-sm mb-md" />
												...
												<div class="form-group sep">
                                                    ...
                                                    <div class="col-xs-8">
                                                    	<div class="col-xs-12" style="padding:0; margin-bottom:5px;">
                                                        <select id="wyca_by_step_edit_map_area_sound" name="area_sound" class="form-control input-sm mb-md select_area_sound">
                                        ...
                                        <div style="clear:both;"></div>
										<a href="#" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal" ><?php echo __('Cancel');?></a>
                                        <a href="#" id="wyca_by_step_edit_map_bAreaSaveConfig" class="btn btn-primary btn_footer_right btn_50" data-dismiss="modal"><?php echo __('Save');?></a>
                                        ...
                                        <div class="h100vh_160" style="overflow:auto; text-align:center">
                                        	...
                                        	<div class="ifUndocked">
                                                <div style="height:200px; position:relative;">
                                                    ...
                                                    <img id="wyca_by_step_edit_map_modalAddDock_robot" src="assets/images/robot-dessus.png" width="50" style="position:absolute; top:130px; margin-left:-25px; z-index:300;" />
                                                    
                                                    <img id="wyca_by_step_edit_map_modalAddDock_dock0" class="dock" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddDock_dock1" class="dock" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddDock_dock2" class="dock" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddDock_dock3" class="dock" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddDock_dock4" class="dock" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddDock_dock5" class="dock" src="assets/images/reflector.png" width="25" />
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        <div class="h100vh_160" style="overflow:auto; text-align:center">
                                        	...
                                        	<form>
                                                <div class="form-group">
                                                    <label class="col-xs-4 control-label"><?= __('Name')?></label>
                                                    <div class="col-xs-8">
                                                        <input type="text" id="wyca_by_step_edit_map_dock_name" name="dock_name" value="" class="form-control input-sm mb-md" />
                                                    </div>
                                                </div>
                                                <!--
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-8">
                                                        <input type="number" id="wyca_by_step_edit_map_dock_number" name="dock_number" value="1" class="form-control input-sm mb-md" />
                                                    </div>
                                                </div>
                                                -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-8">
                                                        <input type="number" id="wyca_by_step_edit_map_dock_fiducial_number" name="fiducial_ID" readonly value="1" class="form-control input-sm mb-md" />
                                                    </div>
                                                </div>
                                                
                                                <input type="hidden" id="wyca_by_step_edit_map_dock_number" name="dock_number" value="1" />
                                                
                                                <div class="form-group">
                                                    <label for="dock_is_master" class="col-xs-10 control-label"><?= __('Is default docking station for this robot')?></label>
                                                    <div class="col-xs-2">
                                                        <input type="checkbox" id="wyca_by_step_edit_map_dock_is_master" name="dock_is_master" class="input-sm mb-md" style="height:auto;" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-xs-4 control-label"><?= __('Comment')?></label>
                                                    <div class="col-xs-8">
                                                        <textarea id="wyca_by_step_edit_map_dock_comment" name="dock_comment" class="form-control input-sm mb-md"></textarea>
                                                    </div>
                                                </div>
                                                <fieldset>
                                        ...
                                        <div style="clear:both;"></div>
                                        <a href="#" id="wyca_by_step_edit_map_bDockCancelConfig" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal" ><?php echo __('Cancel');?></a>
                                        <a href="#" id="wyca_by_step_edit_map_bDockSaveConfig" class="btn btn-primary btn_footer_right btn_50"><?php echo __('Save');?></a>
                                        ...
                                        <div class="h100vh_160" style="overflow:auto; text-align:center">
                                        	...
                                        	<form>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-6">
                                                        <input type="radio" id="wyca_by_step_edit_map_up_elem_action_move" name="up_elem_action" value="move" class="form-control" />
                                                    	<label for="up_elem_action_move" class="control-label"><?= __('Move')?></label>    
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <input type="radio" id="wyca_by_step_edit_map_up_elem_action_rotate" name="up_elem_action" value="rotate" class="form-control" />
                                                ...
                                                <div class="up_elem_action_move">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <input type="radio" id="wyca_by_step_edit_map_up_elem_direction_front" name="up_elem_direction" value="front" class="form-control" />
                                                            <label for="up_elem_direction_front" class="control-label"><?= __('Front')?></label>    
                                                        </div>
                                                        <div class="col-xs-6">
                                                            <input type="radio" id="wyca_by_step_edit_map_up_elem_direction_back" name="up_elem_direction" value="back" class="form-control" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 input-group mb-md">
                                                            <input type="text" value="0" class="form-control" name="up_elem_move_distance" id="wyca_by_step_edit_map_up_elem_move_distance" />
                                                ...
                                                <div class="up_elem_action_rotate">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 input-group mb-md">
                                                            <input type="text" value="0" class="form-control" name="up_elem_rotate_angle" id="wyca_by_step_edit_map_up_elem_rotate_angle" />
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        ...
                                        <a href="#" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal"><?php echo __('Cancel');?></a>
                                        <a href="#" id="wyca_by_step_edit_map_bModalAddPoiSave" class="btn btn-primary btn_footer_right btn_50 ifDocked_disabled"><?php echo __('Add POI');?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        <div class="h100vh_160" style="overflow:auto; text-align:center">
                                        	...
                                        	<form>
                                                <div class="form-group">
                                                    <label class="col-xs-4 control-label"><?= __('Name')?></label>
                                                    <div class="col-xs-8">
                                                        <input type="text" id="wyca_by_step_edit_map_poi_name" name="poi_name" value="" class="form-control input-sm mb-md" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-xs-4 control-label"><?= __('Comment')?></label>
                                                    <div class="col-xs-8">
                                                        <textarea id="wyca_by_step_edit_map_poi_comment" name="poi_comment" class="form-control input-sm mb-md"></textarea>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div style="clear:both;"></div>
										<a href="#" id="wyca_by_step_edit_map_bPoiCancelConfig" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal"><?php echo __('Cancel');?></a>
                                        <a href="#" id="wyca_by_step_edit_map_bPoiSaveConfig" class="btn btn-primary btn_footer_right btn_50"><?php echo __('Save');?></a>
                                        ...
                                        <div class="h100vh_160" style="overflow:auto; text-align:center">
                                        	...
                                        	<div class="ifUndocked">
                                                ...
                                                <div style="height:200px; position:relative;">
                                                    ...
                                                    <img id="wyca_by_step_edit_map_modalAddAugmentedPose_robot" src="assets/images/robot-dessus.png" width="50" style="position:absolute; top:130px; margin-left:-25px; z-index:300;" />
                                                    
                                                    <img id="wyca_by_step_edit_map_modalAddAugmentedPose_augmented_pose0" class="augmented_pose" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddAugmentedPose_augmented_pose1" class="augmented_pose" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddAugmentedPose_augmented_pose2" class="augmented_pose" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddAugmentedPose_augmented_pose3" class="augmented_pose" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddAugmentedPose_augmented_pose4" class="augmented_pose" src="assets/images/reflector.png" width="25" />
                                                    <img id="wyca_by_step_edit_map_modalAddAugmentedPose_augmented_pose5" class="augmented_pose" src="assets/images/reflector.png" width="25" />
													<div class="fiducial_number_wrapper"></div>
                                                </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        <div class="h100vh_160" style="overflow:auto; text-align:center">
                                        	...
                                        	<form>
                                                <div class="form-group">
                                                    <label class="col-xs-4 control-label"><?= __('Name')?></label>
                                                    <div class="col-xs-8">
                                                        <input type="text" id="wyca_by_step_edit_map_augmented_pose_name" name="augmented_pose_name" value="" class="form-control input-sm mb-md" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-xs-4 control-label"><?= __('Fiducial ID')?></label>
                                                    <div class="col-xs-8">	
                                                        <input type="number" id="wyca_by_step_edit_map_augmented_pose_fiducial_number" name="augmented_pose_fiducial_number" readonly value="1" class="form-control input-sm mb-md" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-xs-4 control-label"><?= __('Comment')?></label>
                                                    <div class="col-xs-8">
                                                        <textarea id="wyca_by_step_edit_map_augmented_pose_comment" name="augmented_pose_comment" class="form-control input-sm mb-md"></textarea>
                                                    </div>
                                                </div>
                                                <fieldset>
                                                	<legend><?= __('Undock procedure')?></legend>
                                        ...
                                        <div style="clear:both;"></div>
										<a href="#" id="wyca_by_step_edit_map_bAugmentedPoseCancelConfig" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal"><?php echo __('Cancel');?></a>
                                        <a href="#" id="wyca_by_step_edit_map_bAugmentedPoseSaveConfig" class="btn btn-primary btn_footer_right btn_50"><?php echo __('Save');?></a>
                                        ...
                                        <div class="h100vh_160" style="overflow:auto; text-align:center">
                                        	...
                                        	<form>
                                                <div class="form-group">
                                                    <label class="col-xs-12 control-label"><?= __('Action')?></label>
                                                    <div class="col-xs-6">
                                                        <input type="radio" id="wyca_by_step_edit_map_up_augmented_pose_elem_action_move" name="up_augmented_pose_elem_action" value="move" class="form-control" />
                                                    	<label for="up_augmented_pose_elem_action_move" class="control-label"><?= __('Move')?></label>    
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <input type="radio" id="wyca_by_step_edit_map_up_augmented_pose_elem_action_rotate" name="up_augmented_pose_elem_action" value="rotate" class="form-control" />
                                                ...
                                                <div class="up_augmented_pose_elem_action_move">
                                                    <div class="form-group">
                                                        <label class="col-xs-12 control-label"><?= __('Direction')?></label>
                                                        <div class="col-xs-6">
                                                            <input type="radio" id="wyca_by_step_edit_map_up_augmented_pose_elem_direction_front" name="up_augmented_pose_elem_direction" value="front" class="form-control" />
                                                            <label for="up_augmented_pose_elem_direction_front" class="control-label"><?= __('Front')?></label>    
                                                        </div>
                                                        <div class="col-xs-6">
                                                            <input type="radio" id="wyca_by_step_edit_map_up_augmented_pose_elem_direction_back" name="up_augmented_pose_elem_direction" value="back" class="form-control" />
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-xs-12 control-label"><?= __('Distance')?></label>
                                                        <div class="col-md-6 input-group mb-md">
                                                            <input type="text" value="0" class="form-control" name="up_augmented_pose_elem_move_distance" id="wyca_by_step_edit_map_up_augmented_pose_elem_move_distance" />
                                                            <span class="input-group-addon">m</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="up_augmented_pose_elem_action_rotate">
                                                    <div class="form-group">
                                                        <label class="col-xs-12 control-label"><?= __('Angle')?></label>
                                                        <div class="col-md-6 input-group mb-md">
                                                            <input type="text" value="0" class="form-control" name="up_augmented_pose_elem_rotate_angle" id="wyca_by_step_edit_map_up_augmented_pose_elem_rotate_angle" />
                                                            <span class="input-group-addon ">°</span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        <div class="h100vh_160" style="overflow:auto; text-align:center">
											...
											<div class="wyca_by_step_edit_map_modalReloadMap_loading loading_big" style="margin-top: 50px;"><i class="fa fa fa-spinner fa-pulse fa-2x"></i></div>
                                        </div>
                                        
                                        <div style="clear:both;"></div>
										
                                        <a href="#" id="wyca_by_step_edit_map_bAbortReloadMap" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal" ><?php echo __('No');?></a> 
										<a href="#" id="" class="btn btn-primary btn_footer_right btn_50 wyca_by_step_edit_map_bReloadMap"><?php echo __('Reload Map');?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
										...
										<a href="#" class="btn btn-primary btn_footer_right btn_50 wyca_by_step_edit_map_bReloadMap"><?php echo __('Reload Map');?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="wyca_by_step_edit_map_zoom_popup" style="position:absolute; top:20px; left:20px; width:101px; height:101px; border:1px solid #000; overflow:hidden; display:none; z-index:8000;">
                    <div id="wyca_by_step_edit_map_zoom_popup_content" style="position:absolute; top:0; height:0;"></div>
                    <div id="wyca_by_step_edit_map_zoom_popup_mire" style="position:absolute; width:101px; height:101px; top:0; left:0; background-image:url(assets/images/mire.png);"></div>
                </div>
				<div class="popupHelp">
		...
		<!--
        <section id="wyca_by_step_test_map" class="page with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_edit_map"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                ...
                <div class="wyca_by_step_test_map_loading loading_big"><i class="fa fa fa-spinner fa-pulse"></i></div>
            ...
            <footer>
                ...
                <a href="#" class="btn btn-default button_goto btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_edit_map"><?php echo __('Back');?></a>
            
            	<a href="#" class="btn btn-primary button_goto bTestFinish btn_footer_right btn_50" data-goto="wyca_by_step_config"><?php echo __('Next');?></a>
            </footer>
        </section>
        -->
        
		<section id="wyca_by_step_config" class="page <?php echo $INSTALL_STEP == 30?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_edit_map"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                <form class="form_site" action="" method="post">
					<div class="wyca_by_step_config_loading loading_big" style="padding-top:20px;"><i class="fa fa fa-spinner fa-pulse"></i></div>
					<div class="loaded col-md-12" style="padding-top:25px;">
						<div class="form-group">
							...
							<div class="col-md-6 input-group mb-md">
								<input type="text" value="0" class="form-control" name="i_level_min_gotocharge" id="wyca_by_step_config_i_level_min_gotocharge" />
								<span class="input-group-addon">%</span>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 input-group mb-md">
								<input type="text" value="0" class="form-control" name="i_level_min_dotask" id="wyca_by_step_config_i_level_min_dotask" />
								<span class="input-group-addon">%</span>
							</div>
						</div>
						...
						<a href="#" class="wyca_by_step_config_next button_goto" data-goto="wyca_by_step_export_site" style="display:none;"></a>   
					</div>
                </form>
            ...
            <footer>
				<a href="#" class="btn btn-default button_goto btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_edit_map"><?php echo __('Back');?></a>
            	<a href="#" class="bConfigurationSave btn btn-primary btn_footer_right btn_50" data-goto="wyca_by_step_export_site"><?php echo __('Save');?></a>
            </footer>
        </section>
		
		<section id="wyca_by_step_export_site" class="page <?php echo $INSTALL_STEP == 31?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_config"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                <div class="col-md-12" style="padding-top:10px;">
					...
					<a href="#" class="wyca_by_step_export_site_next button_goto" data-goto="wyca_by_step_maintenance" style="display:none;"></a>
            ...
            <footer>
				<a href="#" class="btn btn-default button_goto btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_config"><?php echo __('Back');?></a>
            	<a href="#" class="btn btn-warning button_goto btn_footer_right btn_50 bExportSiteSkip" data-goto="wyca_by_step_maintenance"><?php echo __('Skip');?></a>
            </footer>
        </section>
		
        <section id="wyca_by_step_maintenance" class="page <?php echo $INSTALL_STEP == 32?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_export_site"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
				...
				<a href="#" class="wyca_by_step_maintenance_next button_goto" data-goto="wyca_by_step_manager" style="display:none;"></a>
						...
						<div class="modal-content">
							<div class="modal-header">
								<div class="actions mh100vh_55">
										...
										<form>
											...
											<div class="form-group nopymy">
												...
												<div class="col-xs-12 col-md-6 input-group input-group-icon">
													<input id="wyca_by_step_maintenance_i_maintenance_password" name="password" type="password" required="required" class="form-control" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*[*.!@$%^&(){}[\]:;<>,.?\/~_+\-=|0-9]).{8,}">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-md-6 input-group input-group-icon">
													<input id="wyca_by_step_maintenance_i_maintenance_cpassword" name="cpassword" type="password" required="required" class="form-control" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*[*.!@$%^&(){}[\]:;<>,.?\/~_+\-=|0-9]).{8,}">
													<span class="input-group-addon">
														<span class="icon icon-lg">
															<i class="fa fa-lock"></i>
														</span>
									...
									<div style="clear:both;"></div>
									<a href="#" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal" ><?php echo __('Cancel');?></a>
									<a href="#" id="wyca_by_step_maintenance_bPasswordMaintenanceSave" class="btn btn-primary btn_footer_right btn_50"><?php echo __('Save');?></a>
								...
								<div class="actions mh100vh_55">
									<div class="h100vh_160" style="overflow:auto">
										...
										<div style="display:flex;align-items: center;    position: absolute;bottom: 70px;">
											<input type="checkbox" class="cb_confirm" id="wyca_by_step_delete_maintenance_account" name="" />  
											<label for="wyca_by_step_delete_maintenance_account" style="margin-left:10px;font-size:16px; color:#000000;"><?php echo __('I confirm that I want to delete WYCA maintenance account.');?></label>
										</div>
            ...
            <footer>
				<a href="#" class="btn btn-default button_goto btn_footer_left btn_100 btn_back" data-goto="wyca_by_step_export_site"><?php echo __('Back');?></a>
            </footer>
        </section>
        
        <section id="wyca_by_step_manager" class="page <?php echo $INSTALL_STEP == 33?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_maintenance"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                ...
                <div class="wyca_by_step_manager_loading loading_big" style="padding-top:50px;"><i class="fa fa fa-spinner fa-pulse"></i></div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        <div class="h100vh_160" style="overflow:auto">
                                            <form>
                                            	<input type="hidden" name="i_id_manager" id="wyca_by_step_manager_i_id_manager" value="-1" />
                                                <div class="form-group" style="display:none">
                                                    <label class="col-xs-12 col-md-3 control-label" for="societe"><?php echo __('Company');?></label>
                                                    <div class="col-xs-12 col-md-6">
                                                        <input id="wyca_by_step_manager_i_manager_societe" value="company" name="societe" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group" style="display:none">
                                                    <label class="col-xs-12 col-md-3 control-label" for="prenom"><?php echo __('Firstname');?></label>
                                                    <div class="col-xs-12 col-md-6">
                                                        <input id="wyca_by_step_manager_i_manager_prenom" value="fname" name="prenom" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group" style="display:none">
                                                    <label class="col-xs-12 col-md-3 control-label" for="nom"><?php echo __('Lastname');?></label>
                                                    <div class="col-xs-12 col-md-6">
                                                        <input id="wyca_by_step_manager_i_manager_nom" value="lname" name="nom" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group nopymy">
                                                    <label class="col-xs-12 col-md-3 control-label" for="email"><?php echo __('Login');?></label>
                                                    <div class="col-xs-12 col-md-6 input-group input-group-icon">
                                                        <input id="wyca_by_step_manager_i_manager_email" name="email" type="email" required="required" pattern="[A-z0-9._%+-]+@[A-z0-9.-]+\.[A-z]{2,}" class="form-control">
														<span class="input-group-addon">
															<span class="icon icon-lg">
																<i class="fas fa-at"></i>
															</span>
                                                ...
                                                <div class="form-group nopymy">
                                                    <label class="col-xs-12 col-md-3 control-label" for="password"><?php echo __('Password');?></label>
                                                    <div class="col-xs-12 col-md-6 input-group input-group-icon">
                                                        <input id="wyca_by_step_manager_i_manager_password" name="password" type="password" required="required" class="form-control" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*[*.!@$%^&(){}[\]:;<>,.?\/~_+\-=|0-9]).{8,}"> 
														<span class="input-group-addon">
															<span class="icon icon-lg">
																<i class="fa fa-lock"></i>
															</span>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-xs-12 col-md-3 control-label" for="cpassword"><?php echo __('Confirm password');?></label>
                                                    <div class="col-xs-12 col-md-6 input-group input-group-icon">
                                                        <input id="wyca_by_step_manager_i_manager_cpassword" name="cpassword" type="password" required="required" class="form-control" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*[*.!@$%^&(){}[\]:;<>,.?\/~_+\-=|0-9]).{8,}">
														<span class="input-group-addon">
															<span class="icon icon-lg">
																<i class="fa fa-lock"></i>
															</span>
                                        ...
                                        <div style="clear:both;"></div>
										<a href="#" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal" ><?php echo __('Cancel');?></a>
                                        <a href="#" id="wyca_by_step_manager_bManagerSave" class="btn btn-primary btn_footer_right btn_50"><?php echo __('Save');?></a>
            ...
            <footer>
				<a href="#" class="btn btn-default button_goto btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_maintenance"><?php echo __('Back');?></a>
            	<a href="#" class="bValidManagerNext btn btn-primary button_goto bValidManager btn_footer_right btn_50" data-goto="wyca_by_step_service_book" style="display:none;"><?php echo __('Next');?></a>
            	<a href="#" class="bValidManagerSkip btn btn-warning button_goto bValidManager btn_footer_right btn_50" data-goto="wyca_by_step_service_book"><?php echo __('Skip');?></a>
            </footer>
        </section>
		
        <section id="wyca_by_step_service_book" class="page <?php echo $INSTALL_STEP == 34?'active':'';?> with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_manager"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
                ...
                <div class="wyca_by_step_service_book_loading loading_big"><i class="fa fa fa-spinner fa-pulse"></i></div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        <div class="h100vh_160" style="overflow:auto">
                                            <form>
                                            	<div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <input id="wyca_by_step_service_book_i_service_book_title" name="title" type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-xs-12 col-md-3 control-label" for="comment"><?php echo __('Comment');?></label>
                                                    <div class="col-xs-12 col-md-6">
                                                        <textarea id="wyca_by_step_service_book_i_service_book_comment" name="comment" style="height:50vh;" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div style="clear:both;"></div>
                                        <a href="#" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal" ><?php echo __('Cancel');?></a>
                                        <a href="#" id="wyca_by_step_service_book_bServiceBookSave" class="btn btn-primary btn_footer_right btn_50" ><?php echo __('Save');?></a>
            ...
            <footer>
				<a href="#" class="btn btn-default button_goto btn_footer_left btn_50 btn_back" data-goto="wyca_by_step_manager"><?php echo __('Back');?></a>
            	<a href="#" class="btn btn-primary button_goto bFinishInstallation btn_footer_right btn_50" data-goto="wyca_by_step_end" style="z-index:2001"><?php echo __('Finish');?></a>
            </footer>
        </section>
        
        <section id="wyca_by_step_end" class="page with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="wyca_by_step_service_book"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
