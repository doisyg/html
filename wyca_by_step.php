		...
		<section id="wyca_by_step_mapping_fin" class="page <?php echo $INSTALL_STEP == 13?'active':'';?> hide_photo_back with_footer">
            ...
            <div class="content">
                ...
                <div style="text-align:center;">
                    ...
                    <form id="wyca_by_step_mapping_form" method="post">
                        ...
                        <input type="text" id="wyca_by_step_mapping_from_name" name="nom" placeholder="<?php echo __('Map name')?>" class="form-control" style="margin-bottom:20px;" />
                    </form>
                    ...
                    <div class="fin_mapping_view" style="height:65vh; width:100%; margin:10px 0; border:1px solid #EFEFEF; position:relative; background-color:#F0F0F0;">
                        ...
                        <div id="wyca_by_step_mapping_divOptionTrinary">
                        ...
                        <div id="wyca_by_step_mapping_divResultTrinary">
                            <div style="max-height:80vh; overflow:auto;">
                                <i style="font-size:60px;" class="fa fa-spinner fa-pulse loading_fin_create_map"></i>
                                <canvas id="wyca_by_step_mapping_canvas_result_trinary" width="" height="" style="max-width:100%; max-height:65vh;"></canvas>
                            </div>
                        </div>
                    </div>
