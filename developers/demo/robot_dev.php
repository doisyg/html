...
<head>
    ...
    <script src="<?php echo $_CONFIG['URL_API'];?>wyca_api.dev.min.php?id_site=<?php echo $_GET['id_site'];?>&api_key=<?php echo $userConnected->api_key;?>"></script>
	...
	$(document).ready(function(e) {
		...
		wycaApi = new WycaAPI({
			...
			dynamic_services : [{'service_name':'/keylo_api/locker/do_distribute', 'message_type':'keylo_api/DoDistributeLocker'}],
			dynamic_topics : [{'topic_name':'/keylo_api/locker/count', 'message_type':'std_msgs/Int8', 'event_name':'TestCountLocker'}],
			TestCountLocker:function(message)
			{
				console.log('TestCountLocker', message);
			},
...
<?php		
		...
		$('#bTestDynService').click(function(e) {
			e.preventDefault();
            wycaApi.CallDynamiqueService('/keylo_api/locker/do_distribute', {}, function(r) { console.log(r); alert('ok'); });
        });
	});
...
<body>
    ...
    wycaApi.StartWebRTC();	
			...
			<a href="#" id="bTestDynService">Test service dyn</a>
