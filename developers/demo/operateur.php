...
<?php
			...
			onGetPhotoCamNav: function(data){
				...
				//$.post( 'ajax/saveJpg.php', { img: data } );
			},
	...
	<?php }}?>
        	    ...
        	    foreach($actionsParGroupe[$groupe] as $action)
	            {
	                if ($action->function_name != '')
	                {
	                    ...
	                    if (count($params['entree'])>0)
	                    {
	                ?><li><a href="#" data-toggle="modal" data-target="#modal_<?php echo $action->function_name;?>"><?php echo $action->function_name;?></a> <span id="reponse_<?php echo $action->function_name;?>"></span></li>
	                <?php
	                    }
	                    else
	                    {
