        ...
        <section id="install_normal_setup" class="page hmi_tuile with_footer">
            ...
            <div class="content">
                <ul class="tuiles row">
                    ...
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile3" data-goto="install_normal_setup_maps" href="#"><i class="fas fa-layer-group"></i><?php echo __('Maps');?></a></li>
