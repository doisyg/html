	<div id="pages_install_normal" class="global_sub_page <?php echo $INSTALL_STEP >= 100?'active':'';?>">
        <section id="install_normal_dashboard" class="page hmi_tuile active">
            ...
            <div class="content">
                <ul class="tuiles row">
					...
					<li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile6" data-goto="install_normal_switch_map_landmark" href="#"><i class="fas fa-exchange-alt"></i><?php echo __('Switch map');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile7" data-goto="install_normal_service_book" href="#"><i class="fa fa-book"></i><?php echo __('Service book');?></a></li>
                    ...
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile9 todo" data-goto="install_normal_help" href="#"><i class="fa fa-question"></i><?php echo __('Help');?></a></li>
                </ul>
					...
					<div class="content sm-content text-left">
						...
						<?php if(file_exists('assets/pdfs/user_manual_'.$_SESSION['id_groupe_user'].'_'.$currentLang->iso.'.pdf')):?>
							...
							<a class="bDownloadUserManual bTuile center btn">
								...
								<h4 class="iconMenuGreen"><?php echo __('Download').'<br>'.__('manual');?></h4>
							</a>
						<?php endif;?>
        ...
        <section id="install_normal_edit_map" class="page with_footer">
            ...
            <div class="content">
                <div id="install_normal_edit_map_container_all">
                    ...
                    <a href="#" id="install_normal_edit_map_bPlusCurrentElem" class="btn btn-circle btn-info btn-menu btnSaveElem"><i class="fa fa-plus"></i></a>
                                        ...
                                        <div class="h100vh_160" style="overflow:auto">
                                            <form>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-8">
                                                        <input type="text" id="install_normal_edit_map_area_name" name="area_name" value="" class="form-control input-sm mb-md" />
                                                    </div>
                                                </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <div class="actions mh100vh_55">
                                        ...
                                        <a href="#" class="btn btn-default btn_footer_left btn_50" data-dismiss="modal"><?php echo __('Cancel');?></a>
                                        <a href="#" id="install_normal_edit_map_bModalAddPoiSave" class="btn btn-primary  btn_footer_right btn_50 ifDocked_disabled"><?php echo __('Add POI');?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="install_normal_setup" class="page hmi_tuile with_footer">
            ...
            <div class="content">
                <ul class="tuiles row">
                    ...
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile6" data-goto="install_normal_setup_check" href="#"><i class="fas fa-tools"></i><?php echo __('Auto Diag');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile7" data-goto="install_normal_setup_wifi" href="#"><i class="fas fa-wifi"></i><?php echo __('Wifi');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile8" data-goto="install_normal_setup_language" href="#"><i class="fa fa-language"></i><?php echo __('Language');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile9" data-goto="install_normal_setup_export" href="#"><i class="fa fa-upload"></i><?php echo __('Export site');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile10" data-goto="install_normal_setup_import" href="#"><i class="fa fa-download"></i><?php echo __('Import site');?></a></li>
					<li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile11" data-goto="install_normal_setup_trinary" href="#"><i class="far fa-map"></i><?php echo __('Map trinary');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile12" data-goto="install_normal_setup_download_map" href="#"><i class="fas fa-file-download"></i><?php echo __('Download map');?></a></li>
                    <li class="col-xs-4 col-md-3 col-lg-2"><a class="button_goto anim_tuiles tuile13" data-goto="install_normal_setup_reset" href="#"><i class="fa fa-eraser"></i><?php echo __('Factory data reset');?></a></li>
				</ul>
				<div class="popupHelp">
					<h2><?=__('Help')?></h2>
					<div class="content sm-content text-left">
							...
							<div class="modal-header">
								<div class="actions mh100vh_55">
									<div class="h100vh_160" style="overflow:auto; text-align:center">
										...
										<div class="row row-eq-height list_maps" id="install_normal_setup_sites_SelectMapList">
										</div>										
									</div>
        ...
        <section id="install_normal_setup_check" class="page hmi_tuile with_footer">
        	<a href="#" class="bBackButton button_goto" data-goto="install_normal_setup"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            	...
            	<div class="max_375" style="position:relative;margin:auto;">
                    ...
                    <ul class="tuiles row max_375" style="position:relative;margin:0;">
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="install_normal_setup_check_lidar" data-line="line_lidar" data-line-placement="bottom" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="install_normal_setup_check_us" data-line="line_us" data-line-placement="bottom" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="install_normal_setup_check_motor" data-line="line_motor" data-line-placement="bottom" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="install_normal_setup_check_battery" data-line="line_battery" data-line-placement="top" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="install_normal_setup_check_cam3d" data-line="line_sensor" data-line-placement="top" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
                        ...
                        <li class="col-xs-4 col-lg-4 tuile_wrapper">
                            <div id="install_normal_setup_check_leds" data-line="line_leds" data-line-placement="top" class="is_checkbox anim_tuiles tuile_img tuile1 no_update">
                                <i class="fa fa-check component_state component_ok"></i>
                                <i class="fa fa-exclamation-triangle component_state component_warning"></i>
                                <i class="fa fa-exclamation-circle component_state component_error"></i>
                                <i class="fa fa fa-spinner fa-pulse"></i>
			...
			<footer>
				<a href="#" class="button_goto btn btn-default btn_footer_left btn_100 bBackSetupCheck" data-goto="install_normal_setup"><?= __('Back')?></a>
            </footer>
        </section>
        ...
        <section id="install_normal_setup_trinary" class="page hide_photo_back with_footer">
            ...
            <div class="content mh100vh_110">
				<div id="install_normal_setup_trinary_divResultTrinary" class="" style="flex:1 1 100%;background-color:#f0f0f0;display:flex;justify-content:center;align-items:center;position:relative">
				
					<svg id="install_normal_setup_trinary_svg" width="0" height="0" style="position:absolute; top:0; left:0; width:100%; height:100%;">
						<image id="install_normal_setup_trinary_image" xlink:href="" x="0" y="0" height="0" width="0" />
					</svg>
					
                    <div id="install_normal_setup_trinary_zoom_carte_container" >
                        <div id="install_normal_setup_trinary_zoom_carte">
                            <img src=""  class="img-responsive" style="max-width:100%; max-height:100%;" />
                            <div id="install_normal_setup_trinary_zone_zoom" style="position:absolute; border:1px solid #00F;"></div>
                            <div id="install_normal_setup_trinary_zone_zoom_click" style="position:absolute; width:100%; height:100%; top:0; left:0; cursor:pointer;"></div>
                        </div>
                    </div>
					
					<canvas id="install_normal_setup_trinary_canvas_result_trinary" width="" height="" style="max-width:100%; max-height:65vh;display:none"></canvas>
        ...
        <section id="install_normal_switch_map_landmark" class="page with_footer">
	        <a href="#" class="bBackButton button_goto" data-goto="install_normal_dashboard"></a>
            <header>
                <div class="pull-left"><img src="assets/images/logo.png" /></div>
            ...
            <div class="content">
				...
				<div class="install_normal_switch_map_landmark_loading loading_big" style="padding-top:30px;"><i class="fa fa fa-spinner fa-pulse"></i></div>
                <div class="loaded col-md-12" style="padding-top:30px;">
				...
				<div id="install_normal_switch_map_landmark_modalFeedback" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
					<div class="modal-dialog" role="dialog">
						<div class="modal-content">
							<div class="modal-header">
								<div class="actions mh100vh_55">
									<div class="h100vh_160" style="overflow:auto; text-align:center;">
										...
										<div class="install_normal_switch_map_landmark_feedback switch_map_feedback">
											<hr style="border-top: 1px solid #909090;">
				...
				<div id="install_normal_switch_map_landmark_modalTeleop" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
					<div class="modal-dialog" role="dialog">
						<div class="modal-content">
							<div class="modal-header">
								<div class="actions mh100vh_55">
