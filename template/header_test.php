...
<html class="fixed">
	<head>
		...
		<link href="assets/stylesheets/fonts/opensans/opensans.css" rel="stylesheet" type="text/css">
		...
		<link rel="stylesheet" href="assets/stylesheets/wyca.css" />';?>
        ...
        <header class="header">
        	...
        	<div class="menu_groupe">
            	<div class="btn-group pull-left" role="group" aria-label="Change group">
					...
					<button type="button" class="btn btn-sm btn-warning">Install</button>
					<button type="button" class="btn btn-sm btn-default">Manager</button>
					<button type="button" class="btn btn-sm btn-default">User</button>
                </ul>
            </div>
        	...
        	<div>
                <div id="icoBattery" class="icone_header" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Battery level">
                	<i class="fa fa-battery-0"></i>
                	<span>100 %</span>
                </div>  
                <div class="icone_header safety_stop" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Emergency stop"><i class="fa fa-exclamation-circle battery-ko"></i></div>
            </div>
