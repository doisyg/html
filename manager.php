...
<div id="pages_manager" class="global_page <?php echo $_SESSION['id_groupe_user'] == 3?'active':'';?>">
			...
			<div id="manager_edit_map_container_all">
				...
				<div id="manager_edit_map_menu" class="menu_icon_touch" style="position:absolute; left:50%; top:50%;">
					<ul>
						...
						<li><a href="#" class="btn btn-circle btn-default btn-menu" data-orientation="H" data-toggle="modal" data-target="#manager_edit_map_modalRecovery">
				...
				<div id="manager_edit_map_modalRecovery" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
					<div class="modal-dialog" role="dialog">
						<div class="modal-content">
							<div class="modal-header">
								<div class="actions mh100vh_55">
	...
	<section id="manager_setup_sites" class="page with_footer">
		...
		<div class="content">
			<a href="#" class="bBackToDashboard button_goto" data-goto="manager_dashboard" style="display:none"></a>
						...
						<div class="modal-header">
							<div class="actions mh100vh_55">
								<div class="h100vh_160" style="overflow:auto; text-align:center">
									...
									<div class="row row-eq-height list_maps" id="manager_setup_sites_SelectMapList">
									</div>										
								</div>
